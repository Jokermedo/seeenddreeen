...
import { PRODUCT_PRICE, ADMIN_WHATSAPP_DISPLAY, PRODUCT_ADVANCE_PAYMENT, PRODUCT_CASH_ON_DELIVERY } from "@/lib/constants";
              ...
              {formData.paymentMethod && (
                <div className="space-y-5 pt-2 animate-in fade-in duration-300">
                  ...
                  <div className="bg-stone-900 rounded-2xl p-5 text-center relative overflow-hidden">
                    ...
                    <p className="text-stone-400 text-xs font-semibold mb-1 relative">رقم المحفظة للتحويل</p>
                    <p className="text-3xl font-black text-white font-mono tracking-widest relative">{ADMIN_WHATSAPP_DISPLAY}</p>
